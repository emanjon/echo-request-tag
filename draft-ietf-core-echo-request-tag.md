...
if security is not end-to-end with the client originating the request, e.g. DTLS between the server and a proxy, then performing a handshake does not provide additional information about the client. 
